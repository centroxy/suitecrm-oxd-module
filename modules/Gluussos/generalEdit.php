                    ...
                    <fieldset style="border: 2px solid #53cc6b; padding: 20px">
                            ...
                            <div style="margin-left: 20px;">
                                <div id="p_role" style="display:<?php if($gluu_users_can_register==1){ echo "none";} ?>;">
                                    ...
                                    if(!empty($gluu_new_roles)) {
                                        ...
                                        ?>
                                        <p class="role_p" style="padding-top: 10px">
                                            <input type="text" name="gluu_new_role[]"  class="form-control" style="display: inline; width: 200px !important;" placeholder="Input role name" value=""/>
                                            <a class="btn btn-xs add_new_role" onclick="test_add()"><span class="glyphicon glyphicon-plus"></span></a>
                                        </p>
                                        <?php
                                    }?>
                        ...
                        <div style="padding-left: 10px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="button button-primary button-large" onclick="edit_cancel_function()" style="text-align:center; float: left; width: 120px" href="index.php?module=Gluussos&action=general">Cancel</a>
                                </td>
                            </tr>
                        </table>
                        </div>
